    ...
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4 py-6">
          {/* MODAL BACKDROP
              Click outside to close the create project modal.
          */}
          <button
            type="button"
          ...
          {/* PROJECT CREATE MODAL
              Form logic stays inside components/project-form.tsx.
            ...
            <div className="flex items-start justify-between border-b border-slate-100 px-6 py-5">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Create a project, assign it to a client, and track budgets,
                  timelines, and project-wise transactions.
                </p>
              </div>
